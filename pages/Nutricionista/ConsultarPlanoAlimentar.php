...
$planoAlimentar = fetchPlanoAlimentar($userId, $conn);
...
<body>
    <div class="main-content">
        <div class="mycontainer">
            ...
            <button onclick="window.location.href='DesabilitarPlanoAlimentar.php?userId=<?php echo $planoAlimentar[0]['id_user']; ?>'" style="height:50px;width: 100%; display: inline-block;">Desabilitar Plano de Nutrição</button>
        </div>
    </div>
</body>
</html>
