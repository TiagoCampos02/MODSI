                        ...
                        <?php if ($result_mensalidades->num_rows > 0): ?>
                            <?php while($row = $result_mensalidades->fetch_assoc()): ?>
                                <div class="card" data-price="<?php echo htmlspecialchars($row['preco']); ?>">
                                    <input type="radio" name="plan" id="plan_<?php echo htmlspecialchars($row['id_mensalidade']); ?>" value="<?php echo htmlspecialchars($row['id']); ?>" required>
                    ...
                    <div class="cards-container">
                        ...
                        <?php if ($result_servicos->num_rows > 0): ?>
                            <?php while($row = $result_servicos->fetch_assoc()): ?>
                                <div class="card" data-price="<?php echo htmlspecialchars($row['preco']); ?>">
                                    <input type="checkbox" name="services[]" id="service_<?php echo htmlspecialchars($row['id_mensalidade']); ?>" value="<?php echo htmlspecialchars($row['id']); ?>" onchange="calculateTotal()">
